...
|---|---|---|---|
| `assets/models/bus_exterior_clean_v1.glb` | `tools/blender_van.py` + `blender_van_side.py`; 10.344 tris; cab-over D100, corredera de altura completa escalonada, ventanas de cabina abiertas, pivotes de corredera y dos puertas traseras, sin ruedas/colisión | `bus_exterior_atlas_v1.png`; paleta canónica + microdetalle high-pass de `van_tex_src_yellow_v1` seed 101, `red_v1` 102 y `cream_v1` 103 | Geometría del proyecto; fuentes FLUX.1 schnell Apache 2.0. Sin marcas/logos. |
| `assets/models/bus_interior_clean_v1.glb` | `tools/blender_bus_interior.py`; 6.460 tris; piso nervado, liners con recorte de ventana, gabinetes/estantes, paquetes visuales y dos asientos automotrices; sin colisión | `bus_interior_atlas_v1.png`; paleta canónica + microdetalle high-pass de `floor_v1` seed 104, `rack_v1` 105, `seat_v1` 106 y `cream_v1` 103 | Geometría del proyecto; fuentes FLUX.1 schnell Apache 2.0. |
| `assets/models/bus_wheel_clean_v1.glb` | `tools/blender_bus_wheel.py`; 1.476 tris; neumático comercial, disco de acero, radio 0,5 m, eje +X; sin colisión | `bus_wheel_atlas_v1.png`; paleta canónica + microdetalle high-pass de `tire_v2` seed 207 y `rim_v1` 108. `tire_v1` seed 107 rechazada por lettering fantasma | Geometría del proyecto; fuentes FLUX.1 schnell Apache 2.0. Neumático genérico: sin Pirelli, texto, logo ni trade dress. |
