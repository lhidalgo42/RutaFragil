...
|---|---|---|---|
| `assets/models/bus_exterior_clean_v1.glb` | `tools/blender_van.py`; 9.844 tris; cab-over D100, pivotes de corredera y dos puertas traseras, sin ruedas/colisión | `bus_exterior_atlas_v1.png`; paleta canónica + microdetalle high-pass de `van_tex_src_yellow_v1` seed 101, `red_v1` 102 y `cream_v1` 103 | Geometría del proyecto; fuentes FLUX.1 schnell Apache 2.0. Sin marcas/logos. |
| `assets/models/bus_interior_clean_v1.glb` | `tools/blender_bus_interior.py`; 6.100 tris; piso nervado, gabinetes/estantes, paquetes visuales y dos asientos automotrices; sin colisión | `bus_interior_atlas_v1.png`; paleta canónica + microdetalle high-pass de `floor_v1` seed 104, `rack_v1` 105, `seat_v1` 106 y `cream_v1` 103 | Geometría del proyecto; fuentes FLUX.1 schnell Apache 2.0. |
