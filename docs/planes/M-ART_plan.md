...
| **DA4** | **Decisión del dueño, bloqueante para el 3D:** instalar Trellis en el servidor, o elegir otro 3D con licencia verificada. Mientras no exista, M-ART entrega imagen y texturas, no mallas. | Sin esto, la parte 3D del pipeline no se puede demostrar con un asset publicable. |
