...
| Interior GLB | 4.320 tris, 8/8, 1 material, 0 imágenes embebidas |
| Rueda GLB | 996 tris, 8/8, 1 material, 0 imágenes embebidas |
| Presupuesto visible | 12.160 / 25.000 tris |
...
4. Sin flicker perceptible parado/en movimiento/ángulo bajo.
5. Copiloto: sentarse/levantarse, vista usable, nunca conduce.
6. Ruedas: cuatro visibles, giro/reversa/dirección delanteras.
7. Neumático genérico sin Pirelli, logos o lettering fantasma.
8. Feel de conducción sin cambio.

Limitaciones declaradas:

- La rueda delantera derecha comparte columna con la puerta lateral por la geometría heredada D90; el arco visual deja hueco, pero el dueño decide su lectura.
